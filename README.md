...
[Comment the issue to tell us](https://github.com/foundVanting/go-admin/issues/71).
...
More framework examples: [https://github.com/foundVanting/go-admin/tree/master/examples](https://github.com/foundVanting/go-admin/tree/master/examples)
