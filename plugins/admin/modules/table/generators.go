...
import (
	...
	"github.com/foundVanting/go-admin/modules/collection"
	...
	"github.com/foundVanting/go-admin/modules/ui"
	...
	"github.com/foundVanting/go-admin/plugins/admin/modules/tools"
...
func (s *SystemTable) GetGenerateForm(ctx *context.Context) (generateTool Table) {
	...
	formList.AddField(lgWithScore("extra import package", "tool"), "extra_import_package", db.Varchar, form.Select).
		FieldOptions(types.FieldOptions{
			...
			{Text: "log", Value: "log"},
			{Text: "fmt", Value: "fmt"},
			{Text: "github.com/foundVanting/go-admin/modules/db/dialect", Value: "github.com/foundVanting/go-admin/modules/db/dialect"},
			{Text: "github.com/foundVanting/go-admin/modules/db", Value: "github.com/foundVanting/go-admin/modules/db"},
			{Text: "github.com/foundVanting/go-admin/modules/language", Value: "github.com/foundVanting/go-admin/modules/language"},
			{Text: "github.com/foundVanting/go-admin/modules/logger", Value: "github.com/foundVanting/go-admin/modules/logger"},
		}).
		FieldDefault("").
