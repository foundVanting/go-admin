...
See [manual](https://github.com/foundVanting/go-admin/projects/3) for more information.
...
For now, you need to add your fork as a remote on the original **\$GOPATH**/src/github.com/foundVanting/go-admin clone, so:

```bash

$ go get github.com/foundVanting/go-admin
$ cd $GOPATH/src/github.com/foundVanting/go-admin # GOPATH is $HOME/go by default.
...
Notice: `go get` return `package github.com/foundVanting/go-admin: no Go files in /go/src/github.com/foundVanting/go-admin` is normal.
...
* [Tasks](https://github.com/foundVanting/go-admin/projects)
